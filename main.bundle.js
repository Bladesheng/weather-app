...
var city = "český dub";
await _modules_MET__WEBPACK_IMPORTED_MODULE_1__.MET.get(city);
  ...
  _createClass(Geocode, null, [{
    ...
    value: function () {
      var _getCoords = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(city) {
        var cityFixed, format, limit, email, url, customHeaders, request, response, expireDate, responseData, point, coords, coordsRounded;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 10:
                ...
                console.log(url); //response.headers.set("expires", "xd");
