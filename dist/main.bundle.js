...
var DOM = function () {
  ...
  function _returnRow(rowData) {
    ...
    var iconTempWrapper = document.createElement("span");
    ...
    temperature.textContent = "".concat(rowData.temperature, "\u02DA");
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n}\n\nhtml {\n  height: -webkit-fill-available;\n}\n\nhtml,\nbody {\n  width: 100vw;\n  max-width: 100%;\n  overflow-x: hidden;\n  font-family: \"Roboto\", sans-serif;\n  color: rgb(250, 250, 250);\n  background-color: rgb(2, 10, 20);\n}\n\nbody {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\nbutton {\n  cursor: pointer;\n}\n\n.dynamicText,\n.dynamicInput {\n  order: 1;\n}\n\n.dynamicText.active svg {\n  color: transparent;\n}\n\n.dynamicInput {\n  display: none;\n}\n\n.dynamicInput.active {\n  display: inline-block;\n}\n\n.loader {\n  position: fixed;\n  z-index: 10;\n  width: 100vw;\n  height: 100vh;\n  background-color: rgba(0, 0, 0, 0.7);\n  display: none;\n  align-items: center;\n  justify-content: center;\n}\n.loader .loaderIcon {\n  width: 15rem;\n}\n.loader .loaderIcon .sunny-body path {\n  fill: rgb(237, 201, 81);\n}\n.loader .loaderIcon .sunny-long-ray {\n  transform-origin: 50% 50%;\n  animation: spin 9s linear infinite;\n}\n.loader .loaderIcon .sunny-long-ray path {\n  fill: rgb(237, 201, 81);\n}\n.loader .loaderIcon .sunny-short-ray {\n  transform-origin: 50% 50%;\n  animation: spin 9s linear infinite;\n}\n.loader .loaderIcon .sunny-short-ray path {\n  fill: rgb(237, 201, 81);\n}\n@keyframes spin {\n  100% {\n    -webkit-transform: rotate(360deg);\n    transform: rotate(360deg);\n  }\n}\n\n.sidebar {\n  z-index: 5;\n  height: 100vh;\n  width: 42vw;\n  position: fixed;\n  left: 0;\n  transition: left 0.4s ease;\n  display: flex;\n  flex-direction: column;\n  gap: 2rem;\n  padding: 1rem;\n  background-color: rgb(23, 31, 40);\n  border-right: 3px solid rgb(57, 74, 92);\n}\n.sidebar .controls {\n  flex: 0 1 auto;\n  display: grid;\n  grid-template-columns: auto 1fr;\n  grid-auto-rows: 1.5rem;\n  column-gap: 1rem;\n  row-gap: 1.2rem;\n  align-items: center;\n}\n.sidebar .controls input[type=checkbox] {\n  width: 1rem;\n  height: 1rem;\n  accent-color: rgb(0, 187, 245);\n  cursor: pointer;\n}\n.sidebar .controls label {\n  font-size: 1.1rem;\n  cursor: pointer;\n  color: rgb(211, 219, 221);\n}\n.sidebar .controls label:hover {\n  filter: brightness(1.2);\n}\n.sidebar .favorites {\n  flex: 1 1 auto;\n  display: flex;\n  flex-direction: column;\n  gap: 1.2rem;\n  font-size: 1.2rem;\n}\n.sidebar .favorites button {\n  font-size: 1rem;\n  color: rgb(211, 219, 221);\n  font-family: \"Roboto\", sans-serif;\n  text-align: start;\n  background: none;\n  border: none;\n}\n.sidebar .favorites button:hover {\n  filter: brightness(1.2);\n}\n.sidebar .credits {\n  flex: 0 0 auto;\n  text-align: center;\n  font-size: 0.6rem;\n  display: flex;\n  flex-direction: column;\n  gap: 0.3rem;\n}\n.sidebar .credits a {\n  text-decoration: none;\n  color: rgb(0, 187, 245);\n}\n\n.sidebar.hidden {\n  left: -42vw;\n  transition: left 0.4s ease;\n}\n\nbutton.burger {\n  position: absolute;\n  left: calc(5vw - 0.9rem);\n  top: 0.6rem;\n  width: 1.8rem;\n  background: none;\n  border: none;\n}\nbutton.burger svg {\n  color: rgb(250, 250, 250);\n}\n\nheader {\n  flex: 0 0 auto;\n  width: 100vw;\n  display: grid;\n  grid-template-columns: 10vw auto 10vw 10vw;\n  grid-template-rows: 3rem;\n  justify-items: center;\n  align-items: center;\n  gap: 1rem;\n  background-color: rgb(23, 31, 40);\n}\nheader .city {\n  grid-column: 2/3;\n  grid-row: 1/2;\n  font-size: 1.4rem;\n  font-weight: 500;\n}\nheader input.search {\n  grid-column: 2/3;\n  grid-row: 1/2;\n  width: 70vw;\n  display: none;\n  height: 2rem;\n  padding: 0 0.6em;\n  font-size: 1.4rem;\n  font-weight: 400;\n  color: rgb(250, 250, 250);\n  background-color: rgb(2, 10, 20);\n  outline: none;\n  border: 2px solid rgb(0, 187, 245);\n  border-radius: 1rem;\n}\nheader button.favorite {\n  grid-column: 3/4;\n  width: 1.8rem;\n  filter: invert(99%) sepia(1%) saturate(165%) hue-rotate(72deg) brightness(117%) contrast(96%);\n  background: none;\n  border: none;\n}\nheader button.search {\n  grid-column: 4/5;\n  width: 1.8rem;\n  background: none;\n  border: none;\n}\nheader button.search svg {\n  color: rgb(250, 250, 250);\n}\n\nmain {\n  flex: 1 1 auto;\n  display: grid;\n  grid-template-columns: 1fr;\n  justify-items: center;\n  gap: 5vw;\n  padding: 3vw;\n}\nmain .dayTab {\n  width: 94vw;\n  padding: 1rem;\n  border-radius: 5px;\n  background-color: rgb(23, 31, 40);\n}\nmain .dayTab .now {\n  display: grid;\n  grid-template-columns: 1fr 2fr 1fr;\n  justify-items: center;\n  align-items: center;\n}\nmain .dayTab .now img {\n  height: 3rem;\n  width: 3rem;\n}\nmain .dayTab .now h1 {\n  font-size: 4rem;\n  font-weight: 700;\n}\nmain .dayTab .now h2 {\n  font-size: 1.3rem;\n  font-weight: 400;\n  color: rgb(211, 219, 221);\n}\nmain .hourlyBreakdown {\n  display: grid;\n}\nmain .hourlyBreakdown .descriptions {\n  display: grid;\n  grid-template-columns: 1.5fr 4fr;\n  grid-template-rows: 2rem;\n  grid-auto-columns: 3fr;\n  grid-auto-flow: column;\n  align-items: center;\n  font-size: 0.7rem;\n  color: rgb(211, 219, 221);\n}\nmain .hourlyBreakdown .descriptions .temperature,\nmain .hourlyBreakdown .descriptions .precipitation,\nmain .hourlyBreakdown .descriptions .humidity,\nmain .hourlyBreakdown .descriptions .pressure,\nmain .hourlyBreakdown .descriptions .wind {\n  justify-self: center;\n}\nmain .hourlyBreakdown .row.data:nth-child(odd) {\n  background-color: rgb(30, 38, 47);\n  border-radius: 2px;\n}\nmain .hourlyBreakdown .data {\n  display: grid;\n  grid-template-columns: 1.5fr 4fr;\n  grid-auto-columns: 3fr;\n  grid-auto-rows: 2rem;\n  grid-auto-flow: column;\n  align-items: center;\n  border-bottom: 1px solid rgb(57, 74, 92);\n}\nmain .hourlyBreakdown .data .time {\n  color: rgb(211, 219, 221);\n}\nmain .hourlyBreakdown .data .iconTemperature {\n  display: grid;\n  grid-auto-flow: column;\n  grid-template-columns: 1fr 1fr;\n  grid-template-rows: 2rem;\n  align-items: center;\n}\nmain .hourlyBreakdown .data .iconTemperature img {\n  justify-self: center;\n  width: 1.5rem;\n}\nmain .hourlyBreakdown .data .iconTemperature .temperature {\n  justify-self: center;\n  color: rgb(255, 45, 64);\n}\nmain .hourlyBreakdown .data .precipitation {\n  color: rgb(0, 187, 245);\n  justify-self: center;\n}\nmain .hourlyBreakdown .data .humidity {\n  justify-self: center;\n}\nmain .hourlyBreakdown .data .pressure {\n  justify-self: center;\n}\nmain .hourlyBreakdown .data .wind {\n  justify-self: center;\n  display: flex;\n  align-items: center;\n}\nmain .hourlyBreakdown .data .wind img {\n  width: 1.5rem;\n  filter: invert(99%) sepia(1%) saturate(2248%) hue-rotate(162deg) brightness(96%) contrast(80%);\n}\nmain .hourlyBreakdown .sun {\n  display: grid;\n  justify-items: center;\n  grid-template-columns: 1fr 1fr;\n  padding-top: 1rem;\n}\nmain .hourlyBreakdown .sun .sunriseSunset {\n  display: grid;\n  justify-items: center;\n  align-items: center;\n}\nmain .hourlyBreakdown .sun .sunriseSunset p {\n  justify-self: center;\n  grid-column: 1/3;\n}\nmain .hourlyBreakdown .sun .sunriseSunset img {\n  grid-column: 1/2;\n  width: 2rem;\n  filter: invert(99%) sepia(1%) saturate(2248%) hue-rotate(162deg) brightness(96%) contrast(80%);\n}\nmain .hourlyBreakdown .sun .sunriseSunset span {\n  grid-column: 2/3;\n}\n\n@media (min-width: 490px) {\n  .sidebar {\n    width: 203px;\n  }\n  .sidebar.hidden {\n    left: -203px;\n  }\n}\n@media (min-width: 1060px) {\n  header {\n    grid-template-columns: 106px auto 106px 106px;\n  }\n  header button.burger {\n    left: calc(53px - 0.9rem);\n  }\n  main {\n    grid-template-columns: 1fr 1fr;\n    gap: 1rem;\n    padding: 1rem;\n  }\n  main .dayTab {\n    width: 500px;\n  }\n}\n@media (min-width: 1550px) {\n  main {\n    grid-template-columns: 1fr 1fr 1fr;\n  }\n  main .dayTab {\n    width: 500px;\n  }\n}", "",{"version":3,"sources":["webpack://./src/style.scss"],"names":[],"mappings":"AAAA;EACE,UAAA;EACA,SAAA;EACA,sBAAA;AACF;;AAYA;EACE,8BAAA;AATF;;AAYA;;EAEE,YAAA;EACA,eAAA;EACA,kBAAA;EAEA,iCApBW;EAqBX,yBApBmB;EAqBnB,gCAfgB;AAKlB;;AAaA;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;AAVF;;AAaA;EACE,eAAA;AAVF;;AAcA;;EAEE,QAAA;AAXF;;AAgBE;EACE,kBAAA;AAbJ;;AAiBA;EACE,aAAA;AAdF;;AAgBA;EACE,qBAAA;AAbF;;AAgBA;EACE,eAAA;EACA,WAAA;EAEA,YAAA;EACA,aAAA;EAEA,oCAAA;EAEA,aAAA;EACA,mBAAA;EACA,uBAAA;AAhBF;AAkBE;EACE,YAAA;AAhBJ;AAmBI;EACE,uBAHU;AAdhB;AAoBI;EACE,yBAAA;EACA,kCAAA;AAlBN;AAqBI;EACE,uBAZU;AAPhB;AAsBI;EACE,yBAAA;EACA,kCAAA;AApBN;AAuBI;EACE,uBArBU;AAAhB;AAwBI;EACE;IACE,iCAAA;IACA,yBAAA;EAtBN;AACF;;AA6BA;EACE,UAAA;EACA,aAAA;EACA,WALc;EAOd,eAAA;EACA,OAAA;EACA,0BARkB;EAUlB,aAAA;EACA,sBAAA;EACA,SAAA;EACA,aAAA;EAEA,iCAjHc;EAkHd,uCAAA;AA7BF;AA+BE;EACE,cAAA;EAEA,aAAA;EACA,+BAAA;EACA,sBAAA;EACA,gBAAA;EACA,eAAA;EACA,mBAAA;AA9BJ;AAgCI;EACE,WAAA;EACA,YAAA;EAEA,8BApIY;EAqIZ,eAAA;AA/BN;AAiCI;EACE,iBAAA;EACA,eAAA;EACA,yBA5IiB;AA6GvB;AAiCI;EACE,uBAAA;AA/BN;AAmCE;EACE,cAAA;EAEA,aAAA;EACA,sBAAA;EACA,WAAA;EAEA,iBAAA;AAnCJ;AAqCI;EACE,eAAA;EACA,yBA9JiB;EA+JjB,iCAjKO;EAkKP,iBAAA;EAEA,gBAAA;EACA,YAAA;AApCN;AAuCI;EACE,uBAAA;AArCN;AAyCE;EACE,cAAA;EAEA,kBAAA;EACA,iBAAA;EAEA,aAAA;EACA,sBAAA;EACA,WAAA;AAzCJ;AA2CI;EACE,qBAAA;EACA,uBArLY;AA4IlB;;AA6CA;EACE,WAAA;EACA,0BAvFkB;AA6CpB;;AA6CA;EACE,kBAAA;EACA,wBAAA;EACA,WAAA;EAEA,aAAA;EAKA,gBAAA;EACA,YAAA;AA/CF;AA2CE;EACE,yBAzMiB;AAgKrB;;AA+CA;EACE,cAAA;EAEA,YAAA;EAEA,aAAA;EACA,0CAAA;EACA,wBAAA;EACA,qBAAA;EACA,mBAAA;EACA,SAAA;EAEA,iCAtNc;AAuKhB;AAiDE;EACE,gBAAA;EACA,aAAA;EAEA,iBAAA;EACA,gBAAA;AAhDJ;AAmDE;EACE,gBAAA;EACA,aAAA;EAEA,WAAA;EACA,aAAA;EACA,YAAA;EACA,gBAAA;EAEA,iBAAA;EACA,gBAAA;EACA,yBAhPiB;EAiPjB,gCA3Oc;EA6Od,aAAA;EACA,kCAAA;EACA,mBAAA;AApDJ;AAuDE;EACE,gBAAA;EACA,aAAA;EAGA,6FAAA;EAGA,gBAAA;EACA,YAAA;AAzDJ;AA4DE;EACE,gBAAA;EACA,aAAA;EAKA,gBAAA;EACA,YAAA;AA9DJ;AA0DI;EACE,yBAzQe;AAiNrB;;AAmEA;EACE,cAAA;EAEA,aAAA;EACA,0BAAA;EACA,qBAAA;EACA,QAAA;EACA,YAAA;AAjEF;AAmEE;EACE,WAAA;EACA,aAAA;EAEA,kBAAA;EAyBA,iCArTY;AA2NhB;AAmEI;EACE,aAAA;EACA,kCAAA;EACA,qBAAA;EACA,mBAAA;AAjEN;AAmEM;EACE,YAAA;EACA,WAAA;AAjER;AAoEM;EACE,eAAA;EACA,gBAAA;AAlER;AAqEM;EACE,iBAAA;EACA,gBAAA;EACA,yBArTe;AAkPvB;AA0EE;EACE,aAAA;AAxEJ;AA0EI;EACE,aAAA;EACA,gCAAA;EACA,wBAAA;EACA,sBAlDS;EAmDT,sBAAA;EACA,mBAAA;EAEA,iBAAA;EACA,yBAxUiB;AA+PvB;AA2EM;;;;;EAKE,oBAAA;AAzER;AA8EI;EACE,iCAAA;EACA,kBAAA;AA5EN;AA+EI;EACE,aAAA;EACA,gCAAA;EACA,sBA3ES;EA4ET,oBAAA;EACA,sBAAA;EACA,mBAAA;EAEA,wCAAA;AA9EN;AAgFM;EACE,yBApWe;AAsRvB;AAiFM;EACE,aAAA;EACA,sBAAA;EACA,8BAAA;EACA,wBAAA;EACA,mBAAA;AA/ER;AAiFQ;EACE,oBAAA;EACA,aAAA;AA/EV;AAiFQ;EACE,oBAAA;EACA,uBAnXO;AAoSjB;AAmFM;EACE,uBAvXU;EAwXV,oBAAA;AAjFR;AAoFM;EACE,oBAAA;AAlFR;AAqFM;EACE,oBAAA;AAnFR;AAsFM;EACE,oBAAA;EACA,aAAA;EACA,mBAAA;AApFR;AAsFQ;EACE,aAAA;EAGA,8FAAA;AAtFV;AA4FI;EACE,aAAA;EACA,qBAAA;EACA,8BAAA;EACA,iBAAA;AA1FN;AA4FM;EACE,aAAA;EACA,qBAAA;EACA,mBAAA;AA1FR;AA4FQ;EACE,oBAAA;EACA,gBAAA;AA1FV;AA6FQ;EACE,gBAAA;EACA,WAAA;EAGA,8FAAA;AA7FV;AAiGQ;EACE,gBAAA;AA/FV;;AAsGA;EAEE;IACE,YAFc;EAlGhB;EAsGA;IACE,YAAA;EApGF;AACF;AAuGA;EACE;IACE,6CAAA;EArGF;EAuGE;IACE,yBAAA;EArGJ;EAyGA;IACE,8BAAA;IACA,SAAA;IACA,aAAA;EAvGF;EAyGE;IACE,YAAA;EAvGJ;AACF;AA2GA;EACE;IACE,kCAAA;EAzGF;EA2GE;IACE,YAAA;EAzGJ;AACF","sourcesContent":["* {\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n}\n\n$font-stack: \"Roboto\", sans-serif;\n$font-color-primary: rgb(250, 250, 250);\n$font-color-secondary: rgb(211, 219, 221);\n$font-color-red: rgb(255, 45, 64);\n$font-color-blue: rgb(0, 187, 245);\n\n$color-primary: rgb(23, 31, 40);\n$color-secondary: rgb(2, 10, 20);\n$color-blue: rgb(57, 74, 92);\n\nhtml {\n  height: -webkit-fill-available;\n}\n\nhtml,\nbody {\n  width: 100vw;\n  max-width: 100%;\n  overflow-x: hidden;\n\n  font-family: $font-stack;\n  color: $font-color-primary;\n  background-color: $color-secondary;\n}\n\nbody {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\nbutton {\n  cursor: pointer;\n}\n\n// stuff for hiding / showing dynamic input field\n.dynamicText,\n.dynamicInput {\n  order: 1;\n}\n\n.dynamicText.active {\n  //display: none;\n  svg {\n    color: transparent;\n  }\n}\n\n.dynamicInput {\n  display: none;\n}\n.dynamicInput.active {\n  display: inline-block;\n}\n\n.loader {\n  position: fixed;\n  z-index: 10;\n\n  width: 100vw;\n  height: 100vh;\n\n  background-color: rgba(0, 0, 0, 0.7);\n\n  display: none; // hidden by default, \"flex\" to show\n  align-items: center;\n  justify-content: center;\n\n  .loaderIcon {\n    width: 15rem;\n    $color-sun: rgb(237, 201, 81);\n\n    .sunny-body path {\n      fill: $color-sun;\n    }\n\n    .sunny-long-ray {\n      transform-origin: 50% 50%;\n      animation: spin 9s linear infinite;\n    }\n\n    .sunny-long-ray path {\n      fill: $color-sun;\n    }\n\n    .sunny-short-ray {\n      transform-origin: 50% 50%;\n      animation: spin 9s linear infinite;\n    }\n\n    .sunny-short-ray path {\n      fill: $color-sun;\n    }\n\n    @keyframes spin {\n      100% {\n        -webkit-transform: rotate(360deg);\n        transform: rotate(360deg);\n      }\n    }\n  }\n}\n\n$sidebar-width: 42vw;\n$sidebarTransition: left 0.4s ease;\n.sidebar {\n  z-index: 5;\n  height: 100vh;\n  width: $sidebar-width;\n\n  position: fixed;\n  left: 0;\n  transition: $sidebarTransition;\n\n  display: flex;\n  flex-direction: column;\n  gap: 2rem;\n  padding: 1rem;\n\n  background-color: $color-primary;\n  border-right: 3px solid $color-blue;\n\n  .controls {\n    flex: 0 1 auto;\n\n    display: grid;\n    grid-template-columns: auto 1fr;\n    grid-auto-rows: 1.5rem;\n    column-gap: 1rem;\n    row-gap: 1.2rem;\n    align-items: center;\n\n    input[type=\"checkbox\"] {\n      width: 1rem;\n      height: 1rem;\n\n      accent-color: $font-color-blue;\n      cursor: pointer;\n    }\n    label {\n      font-size: 1.1rem;\n      cursor: pointer;\n      color: $font-color-secondary;\n    }\n    label:hover {\n      filter: brightness(1.2);\n    }\n  }\n\n  .favorites {\n    flex: 1 1 auto;\n\n    display: flex;\n    flex-direction: column;\n    gap: 1.2rem;\n\n    font-size: 1.2rem;\n\n    button {\n      font-size: 1rem;\n      color: $font-color-secondary;\n      font-family: $font-stack;\n      text-align: start;\n\n      background: none;\n      border: none;\n    }\n\n    button:hover {\n      filter: brightness(1.2);\n    }\n  }\n\n  .credits {\n    flex: 0 0 auto;\n\n    text-align: center;\n    font-size: 0.6rem;\n\n    display: flex;\n    flex-direction: column;\n    gap: 0.3rem;\n\n    a {\n      text-decoration: none;\n      color: $font-color-blue;\n    }\n  }\n}\n.sidebar.hidden {\n  left: -$sidebar-width;\n  transition: $sidebarTransition;\n}\n\nbutton.burger {\n  position: absolute;\n  left: calc(5vw - 0.9rem);\n  top: 0.6rem;\n\n  width: 1.8rem;\n\n  svg {\n    color: $font-color-primary;\n  }\n  background: none;\n  border: none;\n}\n\nheader {\n  flex: 0 0 auto;\n\n  width: 100vw;\n\n  display: grid;\n  grid-template-columns: 10vw auto 10vw 10vw;\n  grid-template-rows: 3rem;\n  justify-items: center;\n  align-items: center;\n  gap: 1rem;\n\n  background-color: $color-primary;\n\n  .city {\n    grid-column: 2 / 3;\n    grid-row: 1 / 2;\n\n    font-size: 1.4rem;\n    font-weight: 500;\n  }\n\n  input.search {\n    grid-column: 2 / 3;\n    grid-row: 1 / 2;\n\n    width: 70vw;\n    display: none; // hidden by default\n    height: 2rem;\n    padding: 0 0.6em;\n\n    font-size: 1.4rem;\n    font-weight: 400;\n    color: $font-color-primary;\n    background-color: $color-secondary;\n\n    outline: none;\n    border: 2px solid $font-color-blue;\n    border-radius: 1rem;\n  }\n\n  button.favorite {\n    grid-column: 3 / 4;\n    width: 1.8rem;\n\n    // https://codepen.io/sosuke/pen/Pjoqqp\n    filter: invert(99%) sepia(1%) saturate(165%) hue-rotate(72deg)\n      brightness(117%) contrast(96%);\n\n    background: none;\n    border: none;\n  }\n\n  button.search {\n    grid-column: 4 / 5;\n    width: 1.8rem;\n\n    svg {\n      color: $font-color-primary;\n    }\n    background: none;\n    border: none;\n  }\n}\n\n$column-time: 1.5fr;\n$column-iconTemp: 4fr;\n$column-other: 3fr;\n\nmain {\n  flex: 1 1 auto;\n\n  display: grid;\n  grid-template-columns: 1fr;\n  justify-items: center;\n  gap: 5vw;\n  padding: 3vw;\n\n  .dayTab {\n    width: 94vw;\n    padding: 1rem;\n\n    border-radius: 5px;\n\n    .now {\n      display: grid;\n      grid-template-columns: 1fr 2fr 1fr;\n      justify-items: center;\n      align-items: center;\n\n      img {\n        height: 3rem;\n        width: 3rem;\n      }\n\n      h1 {\n        font-size: 4rem;\n        font-weight: 700;\n      }\n\n      h2 {\n        font-size: 1.3rem;\n        font-weight: 400;\n        color: $font-color-secondary;\n      }\n    }\n\n    background-color: $color-primary;\n  }\n\n  .hourlyBreakdown {\n    display: grid;\n\n    .descriptions {\n      display: grid;\n      grid-template-columns: $column-time $column-iconTemp;\n      grid-template-rows: 2rem;\n      grid-auto-columns: $column-other;\n      grid-auto-flow: column;\n      align-items: center;\n\n      font-size: 0.7rem;\n      color: $font-color-secondary;\n\n      .temperature,\n      .precipitation,\n      .humidity,\n      .pressure,\n      .wind {\n        justify-self: center;\n      }\n    }\n\n    // alternating row background color\n    .row.data:nth-child(odd) {\n      background-color: rgb(30, 38, 47);\n      border-radius: 2px;\n    }\n\n    .data {\n      display: grid;\n      grid-template-columns: $column-time $column-iconTemp;\n      grid-auto-columns: $column-other;\n      grid-auto-rows: 2rem;\n      grid-auto-flow: column;\n      align-items: center;\n\n      border-bottom: 1px solid $color-blue;\n\n      .time {\n        color: $font-color-secondary;\n      }\n\n      .iconTemperature {\n        display: grid;\n        grid-auto-flow: column;\n        grid-template-columns: 1fr 1fr;\n        grid-template-rows: 2rem;\n        align-items: center;\n\n        img {\n          justify-self: center;\n          width: 1.5rem;\n        }\n        .temperature {\n          justify-self: center;\n          color: $font-color-red;\n        }\n      }\n\n      .precipitation {\n        color: $font-color-blue;\n        justify-self: center;\n      }\n\n      .humidity {\n        justify-self: center;\n      }\n\n      .pressure {\n        justify-self: center;\n      }\n\n      .wind {\n        justify-self: center;\n        display: flex;\n        align-items: center;\n\n        img {\n          width: 1.5rem;\n\n          // https://codepen.io/sosuke/pen/Pjoqqp\n          filter: invert(99%) sepia(1%) saturate(2248%) hue-rotate(162deg)\n            brightness(96%) contrast(80%);\n        }\n      }\n    }\n\n    .sun {\n      display: grid;\n      justify-items: center;\n      grid-template-columns: 1fr 1fr;\n      padding-top: 1rem;\n\n      .sunriseSunset {\n        display: grid;\n        justify-items: center;\n        align-items: center;\n\n        p {\n          justify-self: center;\n          grid-column: 1 / 3;\n        }\n\n        img {\n          grid-column: 1 / 2;\n          width: 2rem;\n\n          // https://codepen.io/sosuke/pen/Pjoqqp\n          filter: invert(99%) sepia(1%) saturate(2248%) hue-rotate(162deg)\n            brightness(96%) contrast(80%);\n        }\n\n        span {\n          grid-column: 2 / 3;\n        }\n      }\n    }\n  }\n}\n\n@media (min-width: 490px) {\n  $sidebar-width: 203px;\n  .sidebar {\n    width: $sidebar-width;\n  }\n  .sidebar.hidden {\n    left: -$sidebar-width;\n  }\n}\n\n@media (min-width: 1060px) {\n  header {\n    grid-template-columns: 106px auto 106px 106px;\n\n    button.burger {\n      left: calc(53px - 0.9rem);\n    }\n  }\n\n  main {\n    grid-template-columns: 1fr 1fr;\n    gap: 1rem;\n    padding: 1rem;\n\n    .dayTab {\n      width: 500px;\n    }\n  }\n}\n\n@media (min-width: 1550px) {\n  main {\n    grid-template-columns: 1fr 1fr 1fr;\n\n    .dayTab {\n      width: 500px;\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
